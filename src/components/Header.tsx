...
import { changeInputValue, cleanBooks, setStartIndex } from '../store/reducers/BookSlice';

const Header = () => {
   const sorts = ['relevance', 'newest'];

   const dispatch = useAppDispatch();
   const { value, startIndex, books } = useAppSelector((state) => state.bookReducer);

   const handleChange = (e: any) => {
      dispatch(cleanBooks({ books, startIndex }));
      e.preventDefault();
